...
import java.io.*;
import java.net.*;
// Все то же самое что и в 7 , только многопоток
public class Crawler {
  static int numThreads = 10; // Количество потоков
  static int timeOut = 1000; //Выставляем таймаут
  public static void main(String[] args) {
    ...
    URLPool pool = new URLPool(2); //Создается пулл всех ссылок для хранения
